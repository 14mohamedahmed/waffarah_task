...
import 'package:waffaraha_task/components/packages/toast/message_handlers.dart';
...
class DioInterceptor extends Interceptor {
  ...
  void onResponse(Response response, ResponseInterceptorHandler handler) {
    ...
    // also we can refresh token and re-call the same request after token updated if needed.
    late String message;
